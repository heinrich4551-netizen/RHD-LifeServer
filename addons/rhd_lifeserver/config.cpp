...
class CfgRemoteExec {
    class Functions {
        mode=1; jip=0;
        class RHD_fnc_harvestServer {allowedTargets=2;jip=0;}; class RHD_fnc_refineServer {allowedTargets=2;jip=0;};
        class RHD_fnc_harvestResult {allowedTargets=1;jip=0;}; class RHD_fnc_refineResult {allowedTargets=1;jip=0;};
        class RHD_fnc_setPrice {allowedTargets=2;jip=0;}; class RHD_fnc_createContract {allowedTargets=2;jip=0;};
        class RHD_fnc_completeContract {allowedTargets=2;jip=0;}; class RHD_fnc_contractResult {allowedTargets=1;jip=0;};
    };
...
class CfgVehicles {
    class Logic;
    class Module_F : Logic { class AttributesBase {class Edit;class Checkbox;class Combo;class ModuleDescription;}; class ModuleDescription {}; };
    ...
    class RHD_Module_ResourceNode : Module_F {
        ...
        class ModuleDescription : ModuleDescription {description="Place this at a farming or mining location. No map marker is required.";};
    };
    class RHD_Module_ProcessStation : Module_F {
        ...
        class ModuleDescription : ModuleDescription {description="Place this at a processing facility and enter the exact ProcessAction class.";};
    };
};
