/* Server-side warrant creation. [targetUID,reason,durationSeconds] call RHD_fnc_createWarrant */
...
_w set [_id,[_id,_uid,_reason,diag_tickTime,diag_tickTime + (_duration max 60),remoteExecutedOwner]];
